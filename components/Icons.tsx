...
// Icon components using CSS and Unicode symbols
...
export const MicroscopeIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        <path d="M9.5 12c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5-1.12-2.5-2.5-2.5-2.5 1.12-2.5 2.5zm2.5-4c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z" />
        <path d="M9.5 12c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5-1.12-2.5-2.5-2.5-2.5 1.12-2.5 2.5z" />
    </svg>
);
